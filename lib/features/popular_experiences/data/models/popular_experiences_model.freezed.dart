...
class _$PopularExperiencesImpl implements _PopularExperiences {
  ...
  @override
  String toString() {
    return 'PopularExperiences(id: $id, name: $name, address: $address, description: $description, adultPrice: $adultPrice, childPrice: $childPrice, imagePath: $imagePath, addresses: $addresses, images: $images, isFavourite: $isFavourite, offers: $offers)';
  }
...
abstract class _PopularExperiences implements PopularExperiences {
  const factory _PopularExperiences(
      ...
      required final List<Trips>? offers}) = _$PopularExperiencesImpl;
